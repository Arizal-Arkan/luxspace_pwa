...
async function subcribe() {
    const key = "BCNc2MnFy-oq5FPZihPosZW9YaCtWjvv-VwQ8y5RDmFxCLmiG0KBy1uJ4PIhiSq7wKtbO2Sxa8s0Z4E2h11n0A4";
                ...
                <div className="container mx-auto min-h-screen">
                    ...
                    <ul className="max-w-full md:max-w-lg mx-auto">
                        ...
                        >
                            ...
                            <button className="hover:underline appearance-none" onClick={subcribe}>Subcribe</button>
                        </li>
                        <li
                            className="pb-3 mb-2 flex items-center justify-between w-full border-b border-gray-100"
                        >
